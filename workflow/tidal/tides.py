"""
tides.py — Tidal constituent data: frequencies, nodal factors, equilibrium arguments.
Copied from pyschism (MIT licence) and adapted to remove the pyschism
package dependency. Only requires numpy and datetime.
"""
...
# Use local copies instead of pyschism imports
from workflow.tidal.tpxo import TPXO

_logger = logging.getLogger(__name__)

# FES2014 and HAMTIDE not used in our workflow — stub them out
class FES2014:
    pass
class HAMTIDE:
    pass
