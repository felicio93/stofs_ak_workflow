...
Called by UfsSchismDriver.run(). Dispatches the enabled Phase 4 steps:
  ...
  setup_run   Populate R{ID}_{group_id}/ run directories
              (interactive, fast).
  submit_run  Launch auto_hotstart.py group-by-group, chaining
              hotstarts. BLOCKING — launch inside screen/tmux.
